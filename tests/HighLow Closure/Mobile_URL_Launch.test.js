...
test('Mobile URL Launch', async ({ page }, testInfo) => {
    ...
    await expect(mobile).toHaveURL(/legal\/jp\/HLMI_Internationals_Affiliate_Terms_jp\.pdf\?v4\.23\.11/);

    const response1 = await mobile.goto(cdnUrl + '/legal/jp/HLMI_Internationals_Account_Terms_jp.pdf?v4.23.09');
